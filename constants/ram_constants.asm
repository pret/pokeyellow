...
DEF TEXT_DELAY_SLOW   EQU %101 ; 5
	...
	const_def
	const TEXT_DELAY_INDEX_FAST   ; 0
	const TEXT_DELAY_INDEX_MEDIUM ; 1
	const TEXT_DELAY_INDEX_SLOW   ; 2
	
	const_def 
	const OPTIONS_CURSOR_TEXT_SPEED  ; 0
	const_skip 3                     ; 1-3 ; unused
	const OPTIONS_CURSOR_PRINT       ; 4
	const_skip 2
	const OPTIONS_CURSOR_CANCEL      ; 7
...
DEF PRINTER_BRIGHTNESS_DARKEST  EQU $7f
	...
	const_def
	const PRINTER_INDEX_LIGHTEST ; 0
	const PRINTER_INDEX_LIGHTER  ; 1
	const PRINTER_INDEX_NORMAL   ; 2
	const PRINTER_INDEX_DARKER   ; 3
	const PRINTER_INDEX_DARKEST  ; 4
