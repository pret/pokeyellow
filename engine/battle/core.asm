...
; note that this means that even the highest accuracy is still just a 255/256 chance, not 100%
	; The following snippet is taken from Poekmon Crystal, it fixes the the above bug.
	ld a, b 
	cp $FF ; is the value $FF?
	ret z ; If so skip the calculation 
	call BattleRandom
	cp b
	jr nc, .moveMissed
	ret
