...
; Characteristics of each move.
	...
	move FLY,          NO_ADDITIONAL_EFFECT,		80, FLYING,       100, 15
	...
	move DOUBLE_KICK,  ATTACK_TWICE_EFFECT,         45, FIGHTING,     100, 30
	...
	move SAND_ATTACK,  ACCURACY_DOWN1_EFFECT,        0, NORMAL,       100,  1
	...
	move PIN_MISSILE,  TWINEEDLE_EFFECT,		    14, BUG,          100, 20
	move LEER,         DEFENSE_DOWN1_EFFECT,         0, NORMAL,       100,  1
	move BITE,         FLINCH_SIDE_EFFECT1,         60, NORMAL,       100, 25
	move GROWL,        ATTACK_DOWN1_EFFECT,          0, NORMAL,       100,  1
	...
	move THUNDER,      PARALYZE_SIDE_EFFECT1,      120, ELECTRIC,      85,  8
	...
	move SKULL_BASH,   DEFENSE_UP1_EFFECT,		    50, NORMAL,       100,  5
	move SPIKE_CANNON, TWO_TO_FIVE_ATTACKS_EFFECT,  20, NORMAL,       100, 15
	move CONSTRICT,    SPEED_DOWN_SIDE_EFFECT,      10, NORMAL,       100, 35
	move AMNESIA,      SPECIAL_UP2_EFFECT,           0, PSYCHIC_TYPE, 100,  5
	move KINESIS,      ACCURACY_DOWN1_EFFECT,        0, PSYCHIC_TYPE,  90, 15
	...
	move SLUDGE_BOMB,  POISON_SIDE_EFFECT2,         90, POISON,        55, 10
	...
	move SKY_ATTACK,   FLINCH_SIDE_EFFECT2,        140, FLYING,       100,  5
	move TRANSFORM,    TRANSFORM_EFFECT,             0, NORMAL,       100, 10
	move BUBBLE,       SPEED_DOWN_SIDE_EFFECT,      20, WATER,        100, 30
	move DIZZY_PUNCH,  NO_ADDITIONAL_EFFECT,        70, NORMAL,       100, 10
	move SPORE,        SLEEP_EFFECT,                 0, GRASS,        100, 15
	move FLASH,        ACCURACY_DOWN1_EFFECT,        0, NORMAL,        85,  1
	move PSYWAVE,      SPECIAL_DAMAGE_EFFECT,        1, PSYCHIC_TYPE, 100, 15
	move SPLASH,       SPLASH_EFFECT,                0, NORMAL,       100, 255
