SSAnne1FRooms_Object:
	...
	def_object_events
	object_event  1,  1, SPRITE_GENTLEMAN, STAY, LEFT, 1, OPP_GENTLEMAN, 1
	object_event 10,  3, SPRITE_GENTLEMAN, STAY, UP, 2, OPP_GENTLEMAN, 2
	object_event 10, 12, SPRITE_YOUNGSTER, STAY, UP, 3, OPP_YOUNGSTER, 8
	object_event 12, 11, SPRITE_COOLTRAINER_F, STAY, LEFT, 4, OPP_LASS, 11
