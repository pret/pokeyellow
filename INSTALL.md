...
If you have different projects that require different versions of `rgbds`, it might not be convenient to install rgbds 1.0.3 globally. Instead, you can put its files in a directory within pokeyellow, such as `pokeyellow/rgbds-1.0.3/`. Then specify it when you run `make`:
